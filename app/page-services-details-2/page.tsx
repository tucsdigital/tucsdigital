					...
					<div className="container position-relative z-1">
						<div className="text-start">
							...
							<div className="d-flex">
								...
								<p className="text-primary mb-0">Detalle del Servicio</p>
							</div>
						</div>
					</div>
					...
					<div className="container">
						<div className="row pt-8">
							<div className="col-lg-8 ps-lg-4 mt-lg-0 mt-8 content">
								...
								<h4 className="my-3">Soluciones de Desarrollo Web Personalizado</h4>
								<p className="mb-0">En el entorno digital actual, destacar requiere más que métodos tradicionales. En <span className="text-900 fw-bold">Tucs Digital</span>, entendemos la importancia de la innovación para el crecimiento y éxito de tu negocio. Nuestras soluciones de desarrollo web a medida están diseñadas para ayudarte a navegar la complejidad del mercado moderno, aprovechando tecnología de vanguardia y estrategias innovadoras para transformar tu presencia online y alcanzar tus objetivos. Implementamos herramientas inteligentes y automatización adaptadas a tus necesidades.</p>
								<div className="d-md-flex align-items-center mt-3 mb-3">
									<ul className="list-unstyled phase-items mb-0">
										<li className="d-flex align-items-center mt-3">
											<img src="/assets/imgs/services-details/check.svg" alt="Tucs Digital" />
											<span className="ms-2 text-900 fw-medium fs-6">Mapeo del recorrido del cliente</span>
										</li>
										<li className="d-flex align-items-center mt-3">
											<img src="/assets/imgs/services-details/check.svg" alt="Tucs Digital" />
											<span className="ms-2 text-900 fw-medium fs-6">Sistemas de feedback de usuarios</span>
										</li>
									</ul>
									<ul className="list-unstyled phase-items ms-md-6 mb-0">
										<li className="d-flex align-items-center mt-3">
											<img src="/assets/imgs/services-details/check.svg" alt="Tucs Digital" />
											<span className="ms-2 text-900 fw-medium fs-6">Prácticas empresariales sostenibles</span>
										</li>
										<li className="d-flex align-items-center mt-3">
											<img src="/assets/imgs/services-details/check.svg" alt="Tucs Digital" />
											<span className="ms-2 text-900 fw-medium fs-6">Responsabilidad Social Corporativa</span>
										</li>
									</ul>
									<ul className="list-unstyled phase-items ms-md-6 mb-0">
										<li className="d-flex align-items-center mt-3">
											<img src="/assets/imgs/services-details/check.svg" alt="Tucs Digital" />
											<span className="ms-2 text-900 fw-medium fs-6">Ideación y conceptualización</span>
										</li>
										<li className="d-flex align-items-center mt-3">
											<img src="/assets/imgs/services-details/check.svg" alt="Tucs Digital" />
											<span className="ms-2 text-900 fw-medium fs-6">Propiedad intelectual</span>
										</li>
									</ul>
								</div>
								<h5 className="pt-4 border-top mb-3 mt-5">Transformación Digital</h5>
								<p className="mb-4">En Tucs Digital, nos comprometemos a ofrecer soluciones innovadoras que generen resultados reales. Nuestro equipo combina conocimiento del sector con experiencia tecnológica para brindar servicios prácticos y visionarios. Trabajamos contigo para entender tus retos y adaptar nuestras soluciones a tus necesidades.</p>
								<div className="row">
									<div className="col-lg-7">
										<div className="d-flex">
											<div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
												<div className="icon">
													<img src="/assets/imgs/services-details/icon-5.svg" alt="Tucs Digital" />
												</div>
											</div>
											<div className="ps-5">
												<h6>Análisis y consultoría digital</h6>
												<p>
													Obtén una visión profunda de tu sector y competencia con nuestro análisis digital integral.
												</p>
											</div>
										</div>
										<div className="d-flex pt-3">
											<div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
												<div className="icon">
													<img src="/assets/imgs/services-details/icon-6.svg" alt="Tucs Digital" />
												</div>
											</div>
											<div className="ps-5">
												<h6>Innovación en modelos de negocio</h6>
												<p>
													Te ayudamos a redefinir tu modelo de negocio para alinearlo con las tendencias actuales y futuras del mercado.
												</p>
											</div>
										</div>
										<div className="d-flex pt-3">
											<div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
												<div className="icon">
													<img src="/assets/imgs/services-details/icon-7.svg" alt="Tucs Digital" />
												</div>
											</div>
											<div className="ps-5">
												<h6>Gestión del cambio</h6>
												<p>
													Gestiona exitosamente el cambio organizacional con nuestra guía experta. Te ayudamos a transitar cada etapa de la transformación digital.
												</p>
											</div>
										</div>
									</div>
									<div className="col-lg-5 mt-lg-0 mt-5">
										<img className="rounded-3" src="/assets/imgs/services-details/img-2.png" alt="Tucs Digital" />
									</div>
								</div>
								<h4 className="mt-3 pt-3 border-top mb-3">Sostenibilidad y Responsabilidad Social</h4>
								<p className="mb-3">Apuesta por el futuro digital con las soluciones innovadoras de Tucs Digital. Permítenos ayudarte a transformar tu organización y alcanzar el éxito. Contáctanos para saber cómo podemos impulsar tu crecimiento.</p>
								<p className="fw-bold text-900">Ideación y desarrollo de conceptos: <span className="fw-medium text-600">Fomentamos la innovación en tu empresa. Facilitamos sesiones de ideación y te ayudamos a desarrollar conceptos viables y rentables.</span></p>
								<p className="fw-bold text-900">Soporte en I+D: <span className="fw-medium text-600">Acelera tus proyectos de innovación con nuestro apoyo experto. Te brindamos los recursos y conocimientos necesarios para hacer realidad tus ideas.</span></p>
								<p className="fw-bold text-900">Gestión de propiedad intelectual: <span className="fw-medium text-600">Protege tus innovaciones con nuestro servicio integral de gestión de propiedad intelectual. Desde patentes hasta registros de marca.</span></p>
								<p className="fw-bold text-900">Análisis y consultoría digital: <span className="fw-medium text-600">Mantente a la vanguardia con análisis de mercado y consultoría estratégica. Te ayudamos a identificar oportunidades y tomar decisiones informadas.</span></p>
								<p className="fw-bold text-900">Innovación en modelos de negocio: <span className="fw-medium text-600">Reinventa tu modelo de negocio para responder a las demandas actuales. Creamos modelos flexibles y escalables para tu empresa.</span></p>
								<h5 className="pt-3 border-top mb-3 mt-5">Preguntas sobre el servicio</h5>
									...
									<div className="px-0 card p-3 border-0 border-bottom bg-transparent rounded-0">
										<div className="px-0 card-header border-0 bg-gradient-1">
											<a className={`${activeItem} == 1 ? "accordion-button" : "accordion-button collapsed"} pointer text-900 fw-bold d-flex align-items-center`} onClick={() => handleActiveItem(1)} data-bs-toggle="collapse">
												...
												<h6 className="m-0">¿Qué incluye el desarrollo web a medida?</h6>
										...
										<div id="collapseOne" className={activeItem == 1 ? "accordion-collapse collapse show" : "accordion-collapse collapse"} data-bs-parent=".accordion">
											<p className="px-0 card-body fs-6 text-600 mb-0">Incluye análisis, diseño, desarrollo, pruebas y puesta en marcha de tu sitio web, totalmente adaptado a tus necesidades y objetivos de negocio.</p>
										</div>
									</div>
									<div className="px-0 card p-3 border-0 border-bottom bg-transparent rounded-0">
										<div className="px-0 card-header border-0 bg-gradient-1">
											<a className={`${activeItem} == 2 ? "accordion-button" : "accordion-button collapsed"} pointer text-900 fw-bold d-flex align-items-center`} onClick={() => handleActiveItem(2)} data-bs-toggle="collapse">
												...
												<h6 className="m-0">¿Puedo solicitar funcionalidades específicas?</h6>
												<span className="ms-auto arrow me-2">
													<svg xmlns="http://www.w3.org/2000/svg" width={13} height={8} viewBox="0 0 13 8" fill="none">
														<path className="stroke-dark" d="M11.5 1L6.25 6.5L1 1" stroke="#111827" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
													</svg>
										...
										<div id="collapseTwo" className={activeItem == 2 ? "accordion-collapse collapse show" : "accordion-collapse collapse"} data-bs-parent=".accordion">
											<p className="px-0 card-body fs-6 text-600 mb-0">Por supuesto, desarrollamos funcionalidades a medida según los requerimientos de tu proyecto y sector.</p>
										</div>
									</div>
									<div className="px-0 card p-3 border-0 border-bottom bg-transparent rounded-0">
										<div className="px-0 card-header border-0 bg-gradient-1">
											<a className={`${activeItem} == 3 ? "accordion-button" : "accordion-button collapsed"} pointer text-900 fw-bold d-flex align-items-center`} onClick={() => handleActiveItem(3)} data-bs-toggle="collapse">
												...
												<h6 className="m-0">¿Ofrecen soporte y mantenimiento?</h6>
												<span className="ms-auto arrow me-2">
													<svg xmlns="http://www.w3.org/2000/svg" width={13} height={8} viewBox="0 0 13 8" fill="none">
														<path className="stroke-dark" d="M11.5 1L6.25 6.5L1 1" stroke="#111827" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
													</svg>
										...
										<div id="collapseThree" className={activeItem == 3 ? "accordion-collapse collapse show" : "accordion-collapse collapse"} data-bs-parent=".accordion">
											<p className="px-0 card-body fs-6 text-600 mb-0">Sí, ofrecemos soporte técnico y mantenimiento para asegurar el correcto funcionamiento y evolución de tu sitio web.</p>
										</div>
									</div>
									<div className="px-0 card p-3 border-0 border-bottom bg-transparent rounded-0">
										<div className="px-0 card-header border-0 bg-gradient-1">
										...
										<div id="collapsefour" className={activeItem == 4 ? "accordion-collapse collapse show" : "accordion-collapse collapse"} data-bs-parent=".accordion">
											<p className="px-0 card-body fs-6 text-600 mb-0">Trabajamos con las tecnologías más modernas y seguras del mercado, adaptándonos a cada proyecto.</p>
										</div>
									</div>
									<div className="px-0 card p-3 border-0 border-bottom bg-transparent rounded-0">
										<div className="px-0 card-header border-0 bg-gradient-1">
											<a className={`${activeItem} == 5 ? "accordion-button" : "accordion-button collapsed"} pointer text-900 fw-bold d-flex align-items-center`} onClick={() => handleActiveItem(5)} data-bs-toggle="collapse">
												...
												<h6 className="m-0">¿Cómo empiezo mi proyecto?</h6>
												<span className="ms-auto arrow me-2">
													<svg xmlns="http://www.w3.org/2000/svg" width={13} height={8} viewBox="0 0 13 8" fill="none">
														<path className="stroke-dark" d="M11.5 1L6.25 6.5L1 1" stroke="#111827" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
													</svg>
										...
										<div id="collapsefive" className={activeItem == 5 ? "accordion-collapse collapse show" : "accordion-collapse collapse"} data-bs-parent=".accordion">
											<p className="px-0 card-body fs-6 text-600 mb-0">Contáctanos y agenda una consulta gratuita. Analizaremos tus necesidades y te propondremos la mejor solución digital para tu negocio.</p>
										</div>
									</div>
								</div>
							</div>
									...
									<div className="p-7">
										...
										<Link href="#contacto" className="d-flex align-items-center mt-8 mb-9">
											...
											<div className="ms-3">
												...
												<h5 className="text-white d-block">+54 9 11 2345 6789</h5>
											</div>
										</Link>
