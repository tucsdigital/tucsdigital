export default function Contact1() {
	return (
		<>
			<section id="contacto" className="section-contact-1 position-relative section-padding">
					...
					<div className="row">
						<div className="col-lg-6">
							<div className="d-flex align-items-center justify-content-center bg-primary-soft-keep border border-2 border-white-keep d-inline-flex rounded-pill px-4 py-2">
								...
								<span className="tag-spacing fs-7 fw-bold text-linear-2 ms-2 text-uppercase">Contacto</span>
							</div>
							<h5 className="ds-5 mt-3 mb-3 text-white">¿Pensando en un proyecto? Ponte en contacto con nosotros.</h5>
							<span className="fs-5 fw-medium text-white">Déjanos saber si tienes alguna pregunta, quieres dejar <br className="d-none d-lg-block" />
								un comentario, o necesitas más información sobre <br className="d-none d-lg-block" />
								Tucs Digital</span>
							<div className="d-flex pt-6 pb-3 align-items-center">
								<div className="bg-white-keep icon-flip position-relative icon-shape icon-xxl rounded-3">
									<div className="icon">
										<img src="/assets/imgs/contact-1/icon-1.svg" alt="Tucs Digital" />
									</div>
								</div>
								<div className="ps-5">
									<h6 className="text-white">Visita nuestra Base de Conocimientos</h6>
							...
							<div className="d-flex pt-3 pb-3 align-items-center">
								...
								<div className="ps-5">
									<h6 className="text-white">Mira Videos de Producto</h6>
									<p className="text-white mb-0">
										Mira nuestros tutoriales en video para guías visuales <br />
							...
							<div className="d-flex pt-3 pb-3 align-items-center">
								<div className="bg-white-keep icon-flip position-relative icon-shape icon-xxl rounded-3">
									<div className="icon">
										<img src="/assets/imgs/contact-1/icon-3.svg" alt="Tucs Digital" />
									</div>
								</div>
								<div className="ps-5">
									<h6 className="text-white">Consulta Gratuita</h6>
									<p className="text-white mb-0">
										Hablemos sobre cómo podemos ayudar a tu <br />
										empresa.
									</p>
								</div>
							</div>
						...
						<div className="col-lg-6 ps-lg-0 pt-5 pt-lg-0">
							<div className="position-relative">
								<div className="position-relative z-2 p-3 p-md-5 p-lg-8 rounded-3 bg-primary">
									<h3 className="text-white">Ponte en contacto</h3>
									<p className="text-white">¿Quieres saber más o contactar con nuestro departamento de ventas?</p>
									<form action="#">
