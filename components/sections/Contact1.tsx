...
export default function Contact1() {
  ...
  if (state.succeeded) {
    return (
      <section
        id="contacto"
        className="section-contact-1 position-relative section-padding"
      >
              ...
              <div className="position-relative">
                <div className="position-relative z-2 p-3 p-md-5 p-lg-8 rounded-3 bg-primary">
                  <div className="text-center">
                    ...
                    <h3 className="text-white mb-3">Mensaje Enviado</h3>
        ...
        <div className="container position-relative z-1">
          <div className="row">
            <div className="col-lg-6">
              ...
              <h5 className="ds-5 mt-3 mb-3 text-white">
                ¿Pensando en un proyecto? Ponte en contacto con nosotros.
              </h5>
              <span className="fs-5 fw-medium text-white">
                Déjanos saber si tienes alguna pregunta, quieres dejar{" "}
                <br className="d-none d-lg-block" />
                un comentario, o necesitas más información sobre{" "}
                <br className="d-none d-lg-block" />
                Tucs Digital
              </span>
              <div className="d-flex pt-6 pb-3 align-items-center">
                ...
                <div className="ps-5">
                  ...
                  <p className="text-white mb-0">
                    Explora artículos de soporte y instrucciones paso a paso{" "}
                    <br />
            ...
            <div className="col-lg-6 ps-lg-0 pt-5 pt-lg-0">
              <div className="position-relative">
                <div className="position-relative z-2 p-3 p-md-5 p-lg-8 rounded-3 bg-primary">
                  ...
                  <p className="text-white">
                    ¿Quieres saber más o contactar con nuestro departamento de
                    ventas?
                  </p>
