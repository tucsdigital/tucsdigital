		...
		<>
			<div className="section-logo-cloud container-fluid pt-110 pb-110 mt-lg-0 border-top border-bottom">
				<div className="container">
					<h5 className="text-500 mb-5 text-center">Trabajamos con grandes empresas</h5>
						...
						<ul className="carouselTicker__list pb-4">
							<Marquee direction="right">
								<li className="carouselTicker__item bg-white py-3 px-4 shadow-1 rounded-2 align-self-center icon-height icon-shape hover-up me-2 mb-2">
									<img className="logo-cloud-img filter-invert" src="/assets/imgs/logo-cloud-3/logo-1.svg" alt="infinia" />
								</li>
								<li className="carouselTicker__item bg-white py-3 px-4 shadow-1 rounded-2 align-self-center icon-height icon-shape hover-up me-2 mb-2">
								...
								<li className="carouselTicker__item bg-white py-3 px-4 shadow-1 rounded-2 align-self-center icon-height icon-shape hover-up me-2 mb-2">
									<svg className="logo-cloud-img mt-3" xmlns="http://www.w3.org/2000/svg" width={80} height={40} viewBox="0 0 95 16" fill="none">
								...
								<li className="carouselTicker__item bg-white py-3 px-4 shadow-1 rounded-2 align-self-center icon-height icon-shape hover-up me-2 mb-2">
									<img className="logo-cloud-img" src="/assets/imgs/logo-cloud-3/logo-7.svg" alt="infinia" />
								</li>
							</Marquee>
						</ul>
					</div>
								...
								<ul className="carouselTicker__list pb-4">
									<Marquee>
										<li className="carouselTicker__item bg-white py-3 px-4 shadow-1 rounded-2 align-self-center icon-height icon-shape hover-up me-2">
											<img className="logo-cloud-img filter-invert" src="/assets/imgs/logo-cloud-3/logo-8.svg" alt="infinia" />
										</li>
										<li className="carouselTicker__item bg-white py-3 px-4 shadow-1 rounded-2 align-self-center icon-height icon-shape hover-up me-2">
											<img className="logo-cloud-img filter-invert" src="/assets/imgs/logo-cloud-3/logo-9.svg" alt="infinia" />
										</li>
										<li className="carouselTicker__item bg-white py-3 px-4 shadow-1 rounded-2 align-self-center icon-height icon-shape hover-up me-2">
											<img className="logo-cloud-img" src="/assets/imgs/logo-cloud-3/logo-3.svg" alt="infinia" />
										</li>
										<li className="carouselTicker__item bg-white py-3 px-4 shadow-1 rounded-2 align-self-center icon-height icon-shape hover-up me-2">
											<img className="logo-cloud-img filter-invert" src="/assets/imgs/logo-cloud-3/logo-10.svg" alt="infinia" />
										</li>
										<li className="carouselTicker__item bg-white py-3 px-4 shadow-1 rounded-2 align-self-center icon-height icon-shape hover-up me-2">
											<img className="logo-cloud-img" src="/assets/imgs/logo-cloud-3/logo-11.svg" alt="infinia" />
										</li>
										<li className="carouselTicker__item bg-white py-3 px-4 shadow-1 rounded-2 align-self-center icon-height icon-shape hover-up me-2">
											<img className="logo-cloud-img filter-invert" src="/assets/imgs/logo-cloud-3/logo-12.svg" alt="infinia" />
										</li>
									</Marquee>
								</ul>
							</div>
