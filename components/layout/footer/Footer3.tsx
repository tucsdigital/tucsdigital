						...
						<div className=" container position-relative z-2">
							...
							<div className="row py-90">
								<div className="col-lg-8">
									<div className="row">
										<div className="col-lg-3 col-md-4 col-6">
											<h3 className="text-white opacity-50 fs-6 fw-black text-uppercase pb-3 pt-5 pt-lg-0">Empresa</h3>
										...
										<div className="col-lg-3 col-md-4 col-6">
											<h3 className="text-white opacity-50 fs-6 fw-black text-uppercase pb-3 pt-5 pt-lg-0">Recursos</h3>
											<div className="d-flex flex-column align-items-start">
										...
										<div className="col-lg-3 col-md-4 col-6">
											<h3 className="text-white opacity-50 fs-6 fw-black text-uppercase pb-3 pt-5 pt-lg-0">Servicios</h3>
											<div className="d-flex flex-column align-items-start">
										...
										<div className="col-lg-3 col-md-4 col-6">
											<h3 className="text-white opacity-50 fs-6 fw-black text-uppercase pb-3 pt-5 pt-lg-0">Soporte</h3>
											<div className="d-flex flex-column align-items-start">
								...
								<div className="col-lg-3 pt-5 pt-lg-0">
									<p className="text-white fw-black opacity-50 text-uppercase">Aplicaciones y Pagos</p>
									<p className="text-white fw-medium mt-3 mb-4 opacity-50">Descarga nuestras aplicaciones y obtén un 15% de descuento en tu primer proyecto…!</p>
							...
							<div className="row">
								<div className="d-flex flex-md-row flex-column align-items-center justify-content-between bg-transparent py-4 border-top border-opacity-10">
									<span className="text-white opacity-50 mb-3 mb-md-0">Copyright © 2024 Tucs Digital. Todos los Derechos Reservados</span>
